 ...
 */
public class ViewPatientByDoc extends javax.swing.JPanel {

    /**
     * Creates new form ViewPatient
     */
    PatientDirectory patientDirectory;
    public ViewPatientByDoc(PatientDirectory patientDirectory) {
        initComponents();
        this.patientDirectory=patientDirectory;
        populateTable();
//        txtTemp.setEnabled(false);
//         txtBloodPressure.setEnabled(); 
//         txtPulseRate.setEnabled(=);
//         txtDiagnosis.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1078, 860));
        ...
        tablePatient.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Gender", "Date of Birth", "Person ID", "Address", "City", "State", "Zip", "Community", "Patient ID", "Enc Datel"
            }
        ));
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tablePatient.getModel();
        Object[] selected_row = new Object[15];
...
private void populateTable() {
        ...
        for(Patient patient : patientDirectory.getPatients()){
            ...
            data[11]= patient.getEncounter().getVitalSign().getBloodPressure();
            data[12]= patient.getEncounter().getVitalSign().getPulseRate();
            data[13]= patient.getEncounter().getDiagnosis();
            data[14]=patient.getEncounter().getVitalSign().getTemp();
